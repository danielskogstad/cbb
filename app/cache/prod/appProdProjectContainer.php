...
class appProdProjectContainer extends Container
{
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/daniel/Sites/cbb/app/Resources');
    ...
    {
        $this->services['data_collector.stash'] = $instance = new \Tedivm\StashBundle\Collector\CacheDataCollector('default', array('default' => 'stash.default_cache'), array('default' => array('handlers' => array(0 => 'FileSystem'), 'registerDoctrineAdapter' => false, 'registerSessionHandler' => false, 'inMemory' => true, 'BlackHole' => array(), 'Ephemeral' => array(), 'FileSystem' => array('dirSplit' => 2, 'path' => '/Users/daniel/Sites/cbb/app/cache/prod/stash', 'filePermissions' => 432, 'dirPermissions' => 504, 'memKeyLimit' => 200, 'keyHashFunction' => 'md5'), 'Memcache' => array('servers' => array(0 => array('server' => '127.0.0.1', 'port' => '11211'))), 'SQLite' => array('filePermissions' => 432, 'dirPermissions' => 504, 'busyTimeout' => 500, 'nesting' => 0, 'subhandler' => 'PDO', 'version' => NULL, 'path' => '/Users/daniel/Sites/cbb/app/cache/prod/stash'))));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'hotmailz2', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_dc3f02e0a3c80087ed42df2ccc1dbb53a78306fc57cec5bbbe0a44888637574f');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_dc3f02e0a3c80087ed42df2ccc1dbb53a78306fc57cec5bbbe0a44888637574f');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_dc3f02e0a3c80087ed42df2ccc1dbb53a78306fc57cec5bbbe0a44888637574f');
        ...
        $d->setProxyDir('/Users/daniel/Sites/cbb/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/daniel/Sites/cbb/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/daniel/Sites/cbb/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/daniel/Sites/cbb/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/daniel/Sites/cbb/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['stash.handler.default_cache'] = call_user_func(array('Tedivm\\StashBundle\\Factory\\HandlerFactory', 'createHandler'), array(0 => 'Ephemeral', 1 => 'FileSystem'), array('BlackHole' => array(), 'Ephemeral' => array(), 'FileSystem' => array('dirSplit' => 2, 'path' => '/Users/daniel/Sites/cbb/app/cache/prod/stash', 'filePermissions' => 432, 'dirPermissions' => 504, 'memKeyLimit' => 200, 'keyHashFunction' => 'md5'), 'Memcache' => array('servers' => array(0 => array('server' => '127.0.0.1', 'port' => '11211'))), 'SQLite' => array('filePermissions' => 432, 'dirPermissions' => 504, 'busyTimeout' => 500, 'nesting' => 0, 'subhandler' => 'PDO', 'version' => NULL, 'path' => '/Users/daniel/Sites/cbb/app/cache/prod/stash')));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/daniel/Sites/cbb/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/daniel/Sites/cbb/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/daniel/Sites/cbb/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/daniel/Sites/cbb/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        ...
        $instance->addPath('/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dljad8ue81ue0jlj');
    }
    ...
    {
        return $this->services['wow.bnet'] = new \Skogstadmedia\Bundle\WoWBundle\Service\BnetService($this->get('stash.default_cache'));
    }
    protected function getAssetic_AssetFactoryService()
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/daniel/Sites/cbb/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/daniel/Sites/cbb/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/daniel/Sites/cbb/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/daniel/Sites/cbb/app/cache/prod',
            'kernel.logs_dir' => '/Users/daniel/Sites/cbb/app/logs',
            ...
            'kernel.secret' => 'dljad8ue81ue0jlj',
            ...
            'session.save_path' => '/Users/daniel/Sites/cbb/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/daniel/Sites/cbb/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/Users/daniel/Sites/cbb/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/daniel/Sites/cbb/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/daniel/Sites/cbb/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/daniel/Sites/cbb/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/Users/daniel/Sites/cbb/app/../web',
            'assetic.write_to' => '/Users/daniel/Sites/cbb/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/daniel/Sites/cbb/app/cache/prod/doctrine/orm/Proxies',
            ...
            'stash.caches.options' => array(
                'default' => array(
                    ...
                    'FileSystem' => array(
                        'dirSplit' => 2,
                        'path' => '/Users/daniel/Sites/cbb/app/cache/prod/stash',
                        'filePermissions' => 432,
                        'dirPermissions' => 504,
                        'memKeyLimit' => 200,
                        'keyHashFunction' => 'md5',
