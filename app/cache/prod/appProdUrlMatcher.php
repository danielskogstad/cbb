    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cbb_homepage')), array (  '_controller' => 'Skogstadmedia\\Bundle\\CbbBundle\\Controller\\DefaultController::indexAction',));
            }
